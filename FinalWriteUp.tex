...
scripts that interact with a MySQL database in distinct ways. Thus, we were
...
2010. We gathered this data, available through bittorrent, and used it as a
starting point.
...
Observatory scans all IPv4 space for servers that respond to https requests. We
...
done by curl'ing the domain at port 443 with a HTTP request. If we received a
